    ...
    const handleExportMyOrders = async () => {
        ...
        try {
            ...
            if (err.response?.data instanceof Blob) {
                ...
                toast.error(
                    err.response?.data?.message || 'Failed to export orders. Please try again.'
                );
            }
        } finally {
                ...
                <div className="mb-8 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm font-medium text-slate-500">
                            Track wholesale shipments, dropship deliveries, and pending profit
                            margins.
                        </p>
                    </div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="mt-0.5 text-xs font-bold text-amber-700">
                                    You have {ndrCount} dropship orders facing delivery issues.
                                    Please contact your customers to avoid RTO charges.
                                </p>
                            </div>
                        </div>
                        <button
                                            ...
                                            {ord.tracking?.awbNumber && (
                                                <a
                                                    href={
                                                        ...
                                                        `https://www.google.com/search?q=${ord.tracking.courierName}+tracking+${ord.tracking.awbNumber}`
                                                    }
                                                    target="_blank"
                                                    rel="noreferrer"
                                    ...
                                    {isExpanded && (
                                        <div className="grid grid-cols-1 gap-8 border-t border-slate-200 bg-white p-6 lg:grid-cols-12">
                                            <div className="space-y-6 lg:col-span-7 xl:col-span-7">
                                                ...
                                                <div className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 p-5">
                                                    ...
                                                    <div className="text-right text-[10px] font-bold text-slate-500">
                                                        <p>
                                                            Actual:{' '}
                                                            {Number(ord.totalActualWeight).toFixed(
                                                                3
                                                            )}{' '}
                                                            kg
                                                        </p>
                                            ...
                                            <div className="space-y-6 lg:col-span-5 xl:col-span-5">
                                                ...
                                                >
                                                    <h4 className="mb-4 flex items-center gap-2 text-xs font-extrabold tracking-widest text-slate-400 uppercase">
                                                        <Truck size={16} /> Shipment &amp; Dispatch
                                                        Info
                                                    </h4>
                                                        ...
                                                        <div className="space-y-3">
                                                            ...
                                                            <div className="grid grid-cols-2 gap-3">
                                                                <div className="rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
                                                                    <p className="mb-1 text-[9px] font-extrabold tracking-widest text-slate-400 uppercase">
                                                                        Platform ID
                                                                    </p>
                                                                    {ord.platformOrderNo ? (
                                                                        <p className="font-mono text-sm font-black break-all text-indigo-700">
                                                                            {ord.platformOrderNo}
                                                                        </p>
                                                                    ) : (
                                                            ...
                                                            {}
                                                            <div className="rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
                                                                <p className="mb-2 text-[9px] font-extrabold tracking-widest text-slate-400 uppercase">
                                                                    Tracking ID / AWB
                                                                </p>
                                                                {ord.tracking?.awbNumber ? (
